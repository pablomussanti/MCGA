...
namespace Safari.Data
{
    public partial class CitaDAC : DataAccessComponent, IRepository<Cita>
    {
        ...
        {
            const string SQL_STATEMENT = "INSERT INTO Cita ([Fecha],[MedicoId],[PacienteId],[SalaId],[TipoServicioId],[Estado],[CreatedBy],[CreatedDate]) VALUES(@Nombre,@Apellido,@Email,@Telefono,@Url,@FechaNacimiento,@Domicilio); SELECT SCOPE_IDENTITY();";
        ...
        {
            const string SQL_STATEMENT = "SELECT [Fecha],[MedicoId],[PacienteId],[SalaId],[TipoServicioId],[Estado],[CreatedBy],[CreatedDate], [ChangedBy], [ChangedDate],[DeletedBy],[DeletedDate],[Deleted] FROM Cita ";
        ...
        {
            const string SQL_STATEMENT = "UPDATE Cita SET [Fecha]= @Fecha,[MedicoId] = @MedicoId,[PacienteId] = @PacienteId,[SalaId] = @SalaId,[TipoServicioId] = @TipoServicioId,[Estado] = @Estado,[CreatedBy] = @CreatedBy,[CreatedDate] = @CreatedDate,[ChangedBy] = @ChangedBy,[ChangedDate] = @ChangedDate,[DeleteBy] = @DeleteBy,[DeleteDate] = @DeleteDate,[Delete] = @Delete WHERE [Id]= @Id ";
            ...
            using (DbCommand cmd = db.GetSqlStringCommand(SQL_STATEMENT))
            {
                ...
                db.AddInParameter(cmd, "@DeleteBy", DbType.AnsiString, Cita.ChangedBy);
                db.AddInParameter(cmd, "@DeleteDate", DbType.AnsiString, Cita.ChangedDate);
                db.AddInParameter(cmd, "@Delete", DbType.AnsiString, Cita.ChangedDate);
        ...
        private Cita loadcita(IDataReader dr)
        {
            ...
            Cita.DeleteBy = GetDataValue<int>(dr, "DeleteBy");
